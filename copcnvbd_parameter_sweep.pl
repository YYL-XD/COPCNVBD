...
my $param1_file1 = "/../CNV_data/simu_chr21_0.2_4x/";
my $param2_file1 = "/sim1_4_4100_read.sort.bam";
my $param3_file1 = "/../CNV_data";
my $param4_file1 = "/../CNV_data/simu_chr21_0.2_4x/result/COPOD_step1";
my $param5_file1 = "/../CNV_data/simu_chr21_0.2_4x/result/COPOD_step1/seg_sim1";
my $param6_file1 = 1000;
my $param7_file1 = 50;

# input param of copodcnvbd
my $param1_file2 = "/../CNV_data/simu_chr21_0.2_4x/";
my $param2_file2 = "/sim1_4_4100_read.sort.bam";
my $param3_file2 = "/../CNV_data/";
my $param4_file2 = "/../CNV_data/simu_chr21_0.2_4x/result/COPOD_step2/";
my $param5_file2 = "/../CNV_data/simu_chr21_0.2_4x/result/COPOD_step1/";
my @param6_values_file2 = (0.2, 0.25, 0.3, 0.35);  
#my $param6_file2 = 0.25;  


# input param of statistic result
# my $param1_file3  = "/../CNV_data/simu_chr21_0.2_4x/result/COPOD_step2/sim1_4_4100_read.sort.bam_step2_result_". $param6_file2 ."alpha.txt";
...
foreach my $param6 (@param6_values_file2) {
    ...
    my $param1_file3  = "/../CNV_data/simu_chr21_0.2_4x/result/COPOD_step2/sim1_4_4100_read.sort.bam_step2_result_". $param6 ."alpha.txt";
